...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  // 4th row
  _______,          _______,          _______,          XP(AC_SE, AC_CE), _______, _______,
  XP(DI_SU, DI_CU), XP(AC_SU, AC_CU), XP(AC_SI, AC_CI), XP(AC_SO, AC_CO), _______, _______,
  // 3rd row
  _______, XP(AC_SA, AC_CA), _______, _______, _______, _______,
  _______, _______,          _______, _______, _______, _______,
  // 2rd row
  _______,          _______, _______, _______, _______, _______,
  XP(TI_SN, TI_CN), _______, _______, _______, _______, _______,
  // 1st row
  _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______
),

...
[_LOWER] = LAYOUT_preonic_grid(
  _______, ES_E,    _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  _______,
  _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, KC_GRV,
  _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
  _______, _______, _______, _______, _______, _______, KC_INS,  KC_DEL,  KC_LBRC, KC_RBRC, ES_Q,    _______,
...
[_RAISE] = LAYOUT_preonic_grid(
  _______, ES_E,    _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  _______,
  _______, _______, _______, AC_E,    _______, _______, DI_U,    AC_U,    AC_I,    AC_O,    _______, KC_GRV,
  _______, AC_A,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, TI_N,    _______, KC_LBRC, KC_RBRC, ES_Q,    _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
